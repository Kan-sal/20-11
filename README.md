...
<body>
    ...
    <script>
        ...
        const textLetterP = "Hôm nay là ngày 20/10. Xin gửi lời chúc tới người mình coi là đặc biệt nhất! Luôn luôn vui vẻ lâu lâu quạo quọ cho cuộc sống nhuộm thêm màu (ehhe), luôn hạnh phúc và gặp nhiều may mắn trong cuộc sống đồng thời cũng càng ngày càng phát triển và tìm lại dược những gì mình cần tìm. Xin gửi tất cả lời chúc tốt đẹp đến với bạn. Lớp vờ YOUUU💗";
